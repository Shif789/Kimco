<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultWatchLiveWechat.aspx.vb" Inherits="CMBusnLocation_resultWatchLiveWechat" %>
...
a {
    ...
    <div class="banner-box">
        <img src="../assets/images/KIMCO ICONS/watchlive_wc_en-us.jpg" class="m-hide">
        <img src="../assets/images/KIMCO ICONS/watchlive_wc_m_en-us.jpg" class="xl-hide">
        
    </div>
    <div class="content-wrap" id="ourgame-section">
       <div class="container clearfix p-3">
        <div class="w-100">
            <h1 class="m-0 text-white bg-golden text-center mb-3">Watch Live Result from WeChat</h1>

            <p class="mt-3 text-justify txt20">
                Today, WeChat messaging mobile app has become an important communication tool in our life and it's one of the world's largest standalone mobile apps in 2018, with over 1 billion monthly active users! KimcoLotto is the First and the Only One in the lottery market who successfully integrated with WeChat in providing the live commentary result for KimcoLotto!
            </p>

            <div class="mb-4">
                <div class="w-75 sm-100 m-auto">
                    <video class="w-100" controls="">
                        <source src="../assets/images/KIMCO ICONS/wechat_live.mp4" type="video/mp4">
                        Your browser does not support HTML5 video.
                    </video>
                </div>
            </div>

            <div class="m-hide hidden">
                <img src="/images/WebUIv2-68.png" class="w-100">
            </div>
            <div class="row xl-hide hidden">
                <div class="col-6 mb-3">
                    <img src="/images/livewechat-1.png" class="w-100">
                </div>

                <div class="col-6 mb-3">
                    <img src="/images/livewechat-2.png" class="w-100">
                </div>

                <div class="col-6 mb-3">
                    <img src="/images/livewechat-3.png" class="w-100">
                </div>

                <div class="col-6">
                    <img src="/images/livewechat-4.png" class="w-100">
                </div>
            </div>
        </div>
    </div>
