<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="Policy.aspx.vb" Inherits="CMBusnLocation_selectUser" %>
        ...
        <div class="tab"> 
            <div class="card-body ">
                 ...
                 <div class="row page-hero d-flex align-items-center justify-content-center">
                  <div>
                      <a href="#"><img id="ctl00_BodyContent_Image2" src="../assets/Ball With Crown.png" class="img-fluid" style="border-width:0px;"></a>
                  </div>                                
              </div>
                <div class="row page-hero d-flex align-items-center justify-content-center">
...
KimcoLotto built the app as a Free app. This SERVICE is provided by Kimco app at no cost and is intended for use as is. This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.<br><br>

If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.<br><br>

The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Kimco App unless otherwise defined in this Privacy Policy.<br><br>
...
If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at <a href="#">kimcoLive@gmail.com</a>
