<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="home.aspx.vb" Inherits="CMBusnLocation_4D" %>
        ...
        <div class="content-wrap bg-kamekame" id="result-section" style="padding:0 0 30px 0">
            <div class="container clearfix" style="padding-left: 15px !important; padding-right: 15px !important;">
                ...
                <div class="main-res">
                    ...
                    <div class="row p-3 main-jp-tab" style="top: -3%;">

                        <div class="col-md-4 p-0 d-none">
                            <div class="jpimage-container">
                                <img src="/images/estJP3_en-us.png" class="w-100">
                                <div class="jpi-abs">
                                    <div class="jpi-abs-icon inline-block">
                                        <img src="/images/icon/4d_icon.png" class="w-100 d-block">
                                    </div>
                                    <div class="jpi-abs-prize inline-block">
                                        <div class="text-danger line-height-1">
                                            
                                        </div>
                                        <span class="dtstamp">Latest Update : 19 Aug 2021, 12:00PM </span>
                                    </div>
                                </div>
                                <div class="jpi-abs-info on-hover-pointer">
                                    <a class="ttip-estjp" href="javascript:;" data-toggle="tooltip" data-placement="bottom" data-html="true" data-trigger="click" data-original-title="<b>Same Day Distribution (SDD) Policy</b><br/>To ensure the fairness of our jackpot distribution, we are applying on the Same Day Distribution (SDD) policy in managing our jackpot pool.<br/><a href='/jackpot/sharing-rules'>Learn More</a>" title=""><i class="icon-question-sign"></i></a>
                                </div>
                        ...
                        <div class="col-md-4 p-0 d-none">
                            <div class="jpimage-container">
                                ...
                                <div class="jpi-abs">
                                    <div class="jpi-abs-icon inline-block">
                                        <img src="/images/icon/61d_icon.png" class="w-100 d-block">
                                    </div>
                                    <div class="jpi-abs-prize inline-block">
                                        <div class="text-danger line-height-1">
                                ...
                                <div class="jpi-abs-info on-hover-pointer">
                                    <a class="ttip-djp" href="javascript:;" data-toggle="tooltip" data-placement="bottom" data-html="true" data-trigger="click" data-original-title="<b>Dragon Jackpot 6+1D</b><br/>Intetested to be a millionaire? Click to know more about Dragon Jackpot 6+1D.<br/><a href='/jackpot/dragon-jackpot'>Learn More</a>" title=""><i class="icon-question-sign"></i></a>
                                </div>

                            </div>
                        </div>
                        
                        <div class="col-md-6 bg-black text-center p-dot5 animate-move-up" <%--onclick="location.href='/results/did-i-win'"--%> title="Did I win?">
                            <img src="../assets/images/KIMCO ICONS/search2.gif" class="w-50 sm-25" style="max-width:80px;">
                            <a href="#" class="text-white sm-show">Did I win?</a>
                        </div>
                        <div class="col-md-6 bg-themered text-center p-dot5 animate-move-up" <%--onclick="location.href='/results/past'"--%> title="Draw Result">
                            <img src="../assets/images/KIMCO ICONS/result2.gif" class="w-50 sm-25" style="max-width:80px;">
                            <a href="#" class="text-white sm-show">Draw Result</a>
                        </div>
                    </div>
...
<div id="result">
    ...
    <!--Second Section -->
       <div id="ajax_gdwp">
<div class="content-wrap" id="highlight-section" style="padding:0 0 30px 0">
    <div class="container clearfix">
        <h2 class="uppercase text-center p-3">Highlights</h2>
        <div class="row">
            
            <div class="col-md-3 col-sm-6 p-2">
                <div class="p-3 card-2 h-100">
                    <div class="position-relative">
                        <img src="../assets/images/KIMCO ICONS/WhatsApp-Image-2021-08-02-at-20.57.40-768x768.jpeg" class="w-100">
                        <div class="HL-box v-mid">
                            <div class="text-center">
                                <a href="http://blog.gdlotto.com/2021/08/466-winners-today-bring-home-usd-4011-each.html" class="HL-viewmore uppercase" target="_blank">View More
                                </a>
                            </div>
                        </div>
                    </div>
                    <div>
                        <a href="http://blog.gdlotto.com/2021/08/466-winners-today-bring-home-usd-4011-each.html" target="_blank" class="pt-2 pb-2 inline-block"><b class="max-text-lines-1">466 winners today bring home USD 4,011 each</b></a><br>
                        <span class="c-gray">
It has been a long time since we have a jackpot and is finally here! Kimco Lotto w <a href="http://blog.gdlotto.com/2021/08/466-winners-today-bring-home-usd-4011-each.html" target="_blank" class="c-gray">[...]</a>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 p-2">
                <div class="p-3 card-2 h-100">
                    <div class="position-relative">
                        <img src="../assets/images/KIMCO ICONS/<%--1-e1621526231799-768x768.jpg--%>jackPot.jpg" class="w-100">
                        <div class="HL-box v-mid">
                            <div class="text-center">
                                <a href="http://blog.gdlotto.com/2021/05/78-winners-bring-home-usd-15484.html" class="HL-viewmore uppercase" target="_blank">View More
                                </a>
                            </div>
                        </div>
                    </div>
                    <div>
                        <a href="http://blog.gdlotto.com/2021/05/78-winners-bring-home-usd-15484.html" target="_blank" class="pt-2 pb-2 inline-block"><b class="max-text-lines-1">78 Winners bring home USD $15,484 each!</b></a><br>
                        <span class="c-gray">
Wow is JACKPOT is finally hit today. The last hit is back on 14 February 2021.  <a href="http://blog.gdlotto.com/2021/05/78-winners-bring-home-usd-15484.html" target="_blank" class="c-gray">[...]</a>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 p-2">
                <div class="p-3 card-2 h-100">
                    <div class="position-relative">
                        <img src="../assets/images/KIMCO ICONS/<%--WhatsApp-Image-2021-04-19-at-16.26.46-e1621526581155-768x768.jpeg--%>hariRaya.jpg" class="w-100">
                        <div class="HL-box v-mid">
                            <div class="text-center">
                                <a href="http://blog.gdlotto.com/2021/05/wishing-all-selamat-hari-raya.html" class="HL-viewmore uppercase" target="_blank">View More
                                </a>
                            </div>
                        </div>
                    </div>
                    <div>
                        <a href="http://blog.gdlotto.com/2021/05/wishing-all-selamat-hari-raya.html" target="_blank" class="pt-2 pb-2 inline-block"><b class="max-text-lines-1">Wishing all Selamat Hari Raya</b></a><br>
                        <span class="c-gray">
Wishing all Selamat Hari Raya 
 <a href="http://blog.gdlotto.com/2021/05/wishing-all-selamat-hari-raya.html" target="_blank" class="c-gray">[...]</a>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 p-2">
                <div class="p-3 card-2 h-100">
                    <div class="position-relative">
                        <img src="../assets/images/KIMCO ICONS/<%--WhatsApp-Image-2021-05-09-at-16.14.27-e1621526723318-768x768.jpeg--%>christmas.jpg" class="w-100">
                        <div class="HL-box v-mid">
                            <div class="text-center">
                                <a href="http://blog.gdlotto.com/2021/05/wishing-all-mother-happy-mothers-day.html" class="HL-viewmore uppercase" target="_blank">View More
                                </a>
                            </div>
                        </div>
                    </div>
                    <div>
                        <a href="http://blog.gdlotto.com/2021/05/wishing-all-mother-happy-mothers-day.html" target="_blank" class="pt-2 pb-2 inline-block"><b class="max-text-lines-1">Wishing all Christmas</b></a><br>
                        <span class="c-gray">
Wishing all Happy Christmas
 <a href="http://blog.gdlotto.com/2021/05/wishing-all-mother-happy-mothers-day.html" target="_blank" class="c-gray">[...]</a>
                        </span>
                    </div>
                </div>
            </div>
...
<div class="content-wrap bg-verylightgray" id="video-section" style="padding:0 0 30px 0">
    <div class="container clearfix pt-4 pl-0 pr-0">
        <div class="card-2 p-5">
            <h2 class="uppercase text-center pb-3">Recent Video</h2>

            
            <div class="row" id="result-video">
                <div class="col-md-10 p-0 pl-md-2 pr-md-2">
                    <div class="fluid-width-video-wrapper" style="padding-top: 56.25%">
                        <iframe id="frameYoutube" width="100%" height="100%" src="https://www.youtube.com/embed/YsEKMuS2_vA?rel=0&amp;vq=large" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                    </div>
                </div>
                <div class="col-md-2 mt-md-0 mt-2">
                    <div class="row">
                        
                        <div class="ytselect col-6 col-md-12 p-2 active" data-yt-video="YsEKMuS2_vA">
                            <img class="w100" src="https://i.ytimg.com/vi/YsEKMuS2_vA/sddefault.jpg">
                            <div class="f-sm center font-weight-bold">4D 2021-08-21</div>
                            <div class="sale-flash sale-flash--mod">
                                LATEST
                            </div>
                        </div>
                        
                        <div class="ytselect col-6 col-md-12 p-2" data-yt-video="f_9P53Vtqk8">
                            <img class="w100" src="https://i.ytimg.com/vi/f_9P53Vtqk8/sddefault.jpg">
                            <div class="f-sm center font-weight-bold">4D 2021-08-20</div>
                        </div>
                        
                        <div class="ytselect col-6 col-md-12 p-2" data-yt-video="3091HP8V4dw">
                            <img class="w-100" src="https://i.ytimg.com/vi/3091HP8V4dw/sddefault.jpg">
                            <div class="f-sm center font-weight-bold">4D 2021-08-19</div>
                        </div>
                        
                        <div class="ytselect col-6 col-md-12 p-2" data-yt-video="MrIuxGJov1A">
                            <img class="w-100" src="https://i.ytimg.com/vi/MrIuxGJov1A/sddefault.jpg">
                            <div class="f-sm center font-weight-bold">4D 2021-08-18</div>
                        </div>
       ...
       <!--Fourth Section-->
       <div id="ajax_gdred">
        <div class="content-wrap" id="recommend-section" style="padding:0 0 30px 0">
            <div class="container clearfix">
                <h2 class="uppercase text-center p-3">Most Redeemed Items</h2>

                <div class="row">
                    <div class="col-12 p-0">
                        <img src="../assets/images/KIMCO ICONS/gdp_ban1.jpg" class="w-100 mb-2">
                    </div>

                    
                    <div class="col-md-3 col-sm-6 p-2">
                        <div class="p-3 card-2 h-100">
                            <div class="position-relative text-center" style="height: 200px;">
                                <img src="../assets/images/KIMCO ICONS/Dyson-3_reference.jpg" class="h-100">
                            </div>
                            <div class="text-center mt-3">
                                <b class="max-text-lines-1">Dyson Supersonic™ hair dryer</b>
                                <div class="btn-2 btn-2-red mt-3" <%--onclick="window.open('http://gdpoints.com/Product/ProductDetail?ProductsId=348', '_blank');"--%>>
                                    View Detail
                                </div>
                                <hr>
                                <b>GD : 2760000</b>
                    ...
                    <div class="col-md-3 col-sm-6 p-2">
                        <div class="p-3 card-2 h-100">
                            <div class="position-relative text-center" style="height: 200px;">
                                <img src="../assets/images/KIMCO ICONS/c4a3d9a910141ec241c3d885ad303da7.jpg" class="h-100">
                            </div>
                            <div class="text-center mt-3">
                                <b class="max-text-lines-1">Oppo Reno 5F 8+128GB</b>
                                <div class="btn-2 btn-2-red mt-3" <%--onclick="window.open('http://gdpoints.com/Product/ProductDetail?ProductsId=347', '_blank');"--%>>
                                    View Detail
                                </div>
                                <hr>
                                <b>GD : 1852500</b>
                    ...
                    <div class="col-md-3 col-sm-6 p-2">
                        <div class="p-3 card-2 h-100">
                            <div class="position-relative text-center" style="height: 200px;">
                                <img src="../assets/images/KIMCO ICONS/202107061201202901.jpg" class="h-100">
                            </div>
                            <div class="text-center mt-3">
                                <b class="max-text-lines-1">Huawei Nova 8i 8+128GB</b>
                                <div class="btn-2 btn-2-red mt-3" <%--onclick="window.open('http://gdpoints.com/Product/ProductDetail?ProductsId=346', '_blank');"--%>>
                                    View Detail
                                </div>
                                <hr>
                                <b>GD : 2002500</b>
                    ...
                    <div class="col-md-3 col-sm-6 p-2">
                        <div class="p-3 card-2 h-100">
                            <div class="position-relative text-center" style="height: 200px;">
                                <img src="../assets/images/KIMCO ICONS/ipad8.jpg" class="h-100">
                            </div>
                            <div class="text-center mt-3">
                                <b class="max-text-lines-1">iPad (8th Generation) WiFi (shipping 4~6 weeks)</b>
                                <div class="btn-2 btn-2-red mt-3" <%--onclick="window.open('http://gdpoints.com/Product/ProductDetail?ProductsId=345', '_blank');"--%>>
                                    View Detail
                                </div>
                                <hr>
                                <b>GD : 2865000</b>
