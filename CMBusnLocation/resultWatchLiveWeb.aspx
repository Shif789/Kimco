<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultWatchLiveWeb.aspx.vb" Inherits="CMBusnLocation_resultsWatchLiveWeb" %>
...
<%--                                                <iframe src="kimcoMenu.html" onload="this.before((this.contentDocument.body||this.contentDocument).children[0]);this.remove()"></iframe>--%>
    ...
    <div class="banner-box">
        <img src="../assets/images/KIMCO ICONS/watchlive_web_en-us.jpg" class="m-hide">
        <img src="../assets/images/KIMCO ICONS/watchlive_web_m_en-us.jpg" class="xl-hide">
        
    </div>
    <div class="content-wrap" id="ourgame-section">
       <div class="container clearfix p-3">
        <div class="w-100">
            <h1 class="m-0 bg-golden text-white text-center mb-3">Watch Live in Website</h1>
            <div class="w-50 sm-100 m-auto">
                <img src="../assets/images/KIMCO ICONS/WebUIv2-67_en-us.png" class="w-100">
            </div>
        </div>
    </div>
    </div>
