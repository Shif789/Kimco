<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultWatchLiveFB.aspx.vb" Inherits="CMBusnLocation_resultsWatchLiveFB" %>
...
a {
    ...
    <div class="banner-box">
        <img src="../assets/images/KIMCO ICONS/watchlive_fb_en-us.jpg" class="m-hide">
        <img src="../assets/images/KIMCO ICONS/watchlive_fb_m_en-us.jpg" class="xl-hide">
        
    </div>
    <div class="content-wrap" id="ourgame-section">
        <div class="container clearfix p-3">
        <div class="w-100">
            <h1 class="m-0 bg-golden text-white text-center mb-3 ">Watch Live From Facebook</h1>
            <p class="txt20 text-justify mt-3">
                Facebook, the world largest social media platform and statistics shown each Asian averagely spent 3 hour a day in Facebook! Hence watching our live draw from Facebook is always the most easy way! Simply turn on the Facebook notifications in our official group and you will never miss our everyday live draw!
            </p>
            <div class="w-50 sm-100 m-auto">
                <img src="../assets/images/KIMCO ICONS/WebUIv2-66_en-us.png" class="w-100">
            </div>
        </div>
    </div>
    </div>
