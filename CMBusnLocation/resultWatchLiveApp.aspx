<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultWatchLiveApp.aspx.vb" Inherits="CMBusnLocation_resultsWatchLiveApp" %>
...
a {
    ...
    <div class="banner-box">
        <img src="../assets/images/KIMCO ICONS/watchlive_app_en-us.jpg" class="m-hide">
        <img src="../assets/images/KIMCO ICONS/watchlive_app_m_en-us.jpg" class="xl-hide">
        
    </div>
    <div class="content-wrap" id="ourgame-section">
        <div class="container clearfix p-3">
        <div class="w-100">
            <h1 class="m-0 text-white bg-golden text-center">Watch Live From KimcoApp</h1>

            <p class="txt20 text-justify mt-3">
                Download our official app from Apple AppStore or Android PlayStore now, and stay alert not only our daily live draw results, but also our latest updates, activities news, prizes and etc. Furthermore, simply register as our members to manage your points, your favourite number, and membership profile!
            </p>

            <div class="mb-4">
                <div class="w-75 sm-100 m-auto">
                    <video class="w-100" controls="">
                        <source src="../assets/images/KIMCO ICONS/android_live.mp4" type="video/mp4">
            ...
            <div class="text-center mb-4">
                <a href="/redirect/?h=APP_AND" target="_blank" class="inline-block">
                    <img src="../assets/images/KIMCO ICONS/ps_google.png">
                </a>
            </div>
            ...
            <div class="mb-4">
                <div class="w-75 sm-100 m-auto">
                    <video class="w-100" controls="">
                        <source src="../assets/images/KIMCO ICONS/iphone_live.mp4" type="video/mp4">
                        Your browser does not support HTML5 video.
                    </video>
                </div>
            </div>
            ...
            <div class="text-center mb-4">
                <a href="/redirect/?h=APP_IOS" target="_blank" class="inline-block">
                    <img src="../assets/images/KIMCO ICONS/ps_apple.png">
                </a>
            </div>

            <!--<div class="m-hide">
                <img src="/images/WebUIv2-65_en-us.png" class="w-100" />
            </div>
            <div class="row xl-hide">
                <div class="col-sm-4 mb-3">
                    <img src="/images/liveapp-1_en-us.png" class="w-100" />
                </div>

                <div class="col-sm-4 mb-3">
                    <img src="/images/liveapp-2_en-us.png" class="w-100" />
                </div>

                <div class="col-sm-4">
                    <img src="/images/liveapp-3_en-us.png" class="w-100" />
                </div>
            </div>

            <div class="text-center mt-4">
                <a href="http://goo.gl/vkAEK6" target="_blank" class="inline-block">
                    <img src="/images/ps_apple.png" />
                </a>
                <a href="http://goo.gl/ybns3q" target="_blank" class="inline-block">
