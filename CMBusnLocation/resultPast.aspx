<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultPast.aspx.vb" Inherits="CMBusnLocation_resultPast" %>
   ...
   <section id="content" style="margin-bottom: 0px;">
        ...
        <div class="content-wrap bg-kamekame" id="result-section" style="padding:0 0 30px 0">
            <div class="container clearfix" style="padding-left: 15px !important; padding-right: 15px !important;">
                <h2 class="text-white text-center font-family-raleway pt-5 pb-3">PAST RESULT</h2>
                <div class="pt-3">

                    <div class="text-center p-3">
                        <b class="align-middle mr-2 text-white">Draw Date</b>
                        <div class="inline-block">
                            <input type="date" id="txtDRes" name="txtDRes" class="default input-2 datepicker large-font" placeholder="MM/DD/YYYY" required="" autocomplete="off">
                    ...
                    <div id="ajax_res4d" class="skeleton-1">
                        <div class="w-75 m-auto sm-100 pb-3 pt-2">
    <div class="fluid-width-video-wrapper" style="padding-top: 56.25%;">
        
        <iframe id="frameYoutube" width="1280" height="720" src="https://www.youtube.com/embed/-8p8Y_FhoEk?rel=0&amp;vq=large" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
