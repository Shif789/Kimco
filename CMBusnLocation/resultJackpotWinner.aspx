<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultJackpotWinner.aspx.vb" Inherits="CMBusnLocation_resultJackpotWinner" %>
                ...
                <div class="container" style="padding-left:15px !important;padding-right:15px !important;">
                    <div class="p-3">
                        ...
                        <div class="w-50 sm-75 m-auto-hori">
                            <img src="../assets/images/KIMCO ICONS/dragonjp_white.png" class="w-100">
                        </div>
                        <div class="text-center p-3">
                            <b class="align-middle mr-2 text-white">Draw Date</b>
                            <div class="inline-block">
                                <input type="date" id="txtDRes" name="txtDRes" class="default input-2 datepicker1 large-font" placeholder="MM/DD/YYYY" required="" autocomplete="off">
                                <button type="button" class="btn-3 btn-3-red font-weight-bold large-font pl-4 pr-4" onclick="">SEARCH</button>
                            </div>

                        </div>
                        <div id="ajax_djpresult" class="text-center">
...
<div class="resultdate ajresultdate mt-2 mb-2">
    ...
    <div class="rdt-center text-white text-center p-2 font-weight-bold uppercase ">Date : 24/10/2021, Sunday</div>
</div>
<div class="bg-white text-center p-4 round-solid-border">
    <div class="row">
        <div class="col-lg-6 v-mid mb-2">
        ...
        <div class="col-lg-6">
            <div class="bg-verylightgray h-100 round-solid-border p-3 v-mid">
                ...
                <div class="c-themered uppercase"><span>next draw</span> : 31 Oct 2021, SUN</div>
            </div>
        </div>
    </div>
    <hr>
    ...
    <div class="row justify-content-center mt-2">
        ...
        <div class="col-md-4 mb-4">
            <img class="medal" src="../assets/images/KIMCO ICONS/medal.png">
            <h4 class="round-solid-border letter-space-1 p-1 djp-winner win">
                0845890
            </h4>
        </div>
    ...
    <div class="round-solid-border bg-verylightgray p-3">
        <div class="row">
            <div class="col-md-6 mb-md-0 mb-2">
                <img src="../assets/images/KIMCO ICONS/trophy.png" style="height: 20px;">&nbsp;
                <span class="c-gray txt14">This indicates current <b>GRAND PRIZE</b> had been won.</span>
            </div>
            <div class="col-md-6">
                <img src="../assets/images/KIMCO ICONS/medal.png" style="height: 20px;">&nbsp;
