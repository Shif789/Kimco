<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="resultDidIWin.aspx.vb" Inherits="CMBusnLocation_resultDidIWin" %>
...
a {
    ...
    <div class="content-wrap bg-verylightgray" id="ourgame-section">
        <div class="container clearfix p-3">
            <h3 class="m-0 bg-golden text-center text-white">CHECK IF YOUR NUMBER HAS WON!</h3>
            <div class="txt13 mt-2 center">This is the
fastest way to check your winning number up to last 12 months period. <br>Simply put
your number, select the period to check, then click search.</div>
                    ...
                    <div class="row text-left mt-2">
                        ...
                        <div class="col-md-8">
                            <select class="w-100 select-center large-font custom-select" name="sltDateRange" id="sltDateRange">
                                <option value="1">Current Draw</option>
