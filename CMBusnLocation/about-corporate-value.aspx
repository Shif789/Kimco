<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="about-corporate-value.aspx.vb" Inherits="CMBusnLocation_4D" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    cursor: default;
        ...
        .fancy-title.title-bottom-border h1, .fancy-title.title-bottom-border h2, .fancy-title.title-bottom-border h3, .fancy-title.title-bottom-border h4, .fancy-title.title-bottom-border h5, .fancy-title.title-bottom-border h6 {
            border-bottom: 2px solid /*#c1272d*/#003032;
        }
    ...
    &#xFEFF;
    <div style="padding:0 0 30px 0" id="corpvalue">
        <div class="container clearfix p-3">
        <h2 class="uppercase c-themered mt-3 mb-4">
            Our Corporate Value
        </h2>
        ...
        <div class="col_one_third">
            ...
            <p>We align our business culture to the ever-evolving need and requirements of the people and organisations we work with. We offer products, services and solutions to provide the best possible customer experience.</p>
        ...
        <div class="col_one_third">
            ...
            <p>We enjoy working for a vibrant organisation,providing hope and opportunity. We are bold, motivated and confident in our collective ability.</p>
        ...
        <div class="col_one_third col_last">
            ...
            <p>We are true to ourselves by being open, honest and committed.</p>
        ...
        <div class="col_one_third">
            ...
            <p>We find ways to do the right things better.</p>
        ...
        <div class="col_one_third">
            ...
            <p>We provide clarity of expectation, consistency of delivery and quality outcomes.</p>
        ...
        <div class="col_one_third col_last">
            ...
            <p>We know our business and our environment. We make the most of opportunities and choose when and how to change.</p>
