<%@ Page Title="" Language="VB" MasterPageFile="~/CMBusnLocation/busnsite.master" AutoEventWireup="false" CodeFile="jackpotHowItWorks.aspx.vb" Inherits="CMBusnLocation_jackpotHowItWorks" %>
...
<%--                                                <iframe src="kimcoMenu.html" onload="this.before((this.contentDocument.body||this.contentDocument).children[0]);this.remove()"></iframe>--%>
    ...
    <div class="tab-content clearfix" id="4d-prize">
            <div class="content-wrap">
                <div class="container clearfix p-3">
                    <div class="mt-3">
                        <div class="w-100">
                            <div class="fluid-width-video-wrapper" style="padding-top: 56.25%;">
                                <iframe id="frameYoutube" width="1280" height="720" src="https://www.youtube.com/embed/CaJUmM54cMg?rel=0&amp;vq=large" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                            </div>
                        </div>
                    </div>

                    <div class="mt-5 text-center m-hide">
                        <img src="../assets/images/KIMCO ICONS/bjp1.png" class="w-75 m-100">
                    </div>

                    <div class="mt-5">
                        <div class="row">
                            <div class="col-md-5">
                                <!--<img src="/images/bjp7.png" class="w-100" />-->
                                <div class="text-center position-relative mt-2">
                                    <img src="../assets/images/KIMCO ICONS/bg_bonusjp_km-kh.png" class="w-100">
                                    <div class="bonusjp-box">
                                        <div class="">
                                            If your 4D number fall into <br>
                                            position A, means you have<br>
                                            3 types of winning possibilities
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7 v-bottom mt-2">
                                <div class="c-themered txt30 font-weight-bold">The First &amp; Only One Live 4D Lottery in Asia! </div>
                                <div class="pb-2 txt18">
                                    Being a leader of Asian’s Lottery provider, we strive to surprise you with Creative, Exciting and Energetic features, and we created “Bonus Jackpot” specially for our loyal players.<br>
                                    <br>

                                    The “Bonus Jackpot” is among the most creative bonus system invented by Grand Dragon Lottery till date, our accumulating bonus system not only gives every player a higher chance to win extra Bonus but also cumulate for the next bonus winner, making you a bigger winner every day!
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-wrap bg-verylightgray">
                <div class="container clearfix p-3">
                    <h2 class="m-0 c-golden">HOW IT WORKS?</h2>

                    <div class="row">
                        <div class="col-2 col-md-1">
                            <div class="c-gray txt20 font-weight-bold c-kimco">STEP</div>
                            <div class="c-golden txt36 font-weight-bold line-height-1">01</div>
                        </div>
                        <div class="col-10 col-md-11">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="txt20 pb-2 c-kimco">
                                ...
                                <div class="col-md-5">
                                    <div>
                                        <img src="../assets/images/KIMCO ICONS/WebUIv2-24_en-us.png" class="w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-2 col-md-1">
                            <div class="c-gray txt20 font-weight-bold c-kimco">STEP</div>
                            <div class="c-golden txt36 font-weight-bold line-height-1">02</div>
                        </div>
                        <div class="col-10 col-md-11">
                            <div class="row m-hide">
                                <div class="col-md-4 border-right">
                                    <div class="txt18 pb-3 c-kimco" style="min-height: 124px;">
                                        Before the drawing end, we have total 13 position (from A to M) for Special Prizes, and we fixed position A as the "Bonus Position".
                                    </div>
                                    <div>
                                        <img src="../assets/images/KIMCO ICONS/bjp-s1_en-us.png" class="w-100">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 border-right">
                                    ...
                                    <div>
                                        <img src="../assets/images/KIMCO ICONS/bjp-s2_en-us.png" class="w-100">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div>
                                        <img src="../assets/images/KIMCO ICONS/bjp-s3_en-us.png" class="w-100">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row xl-hide">
                                ...
                                <div class="col-md-4 border-bottom pt-3 pb-3">
                                    <div class="txt18 pb-3 c-kimco">
                                        If the A being drawn to 2nd prize, mean you have strike our "BIG Bonus".
                                    </div>
                                    <div>
            ...
            <!--<div class="content-wrap" id="sdd-pol">
                <div class="container clearfix p-3">
                    <h2 class="m-0 c-themered">BONUS JACKPOT PAYOUT</h2>
                    <div class="pt-2">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <img src="/images/WebUIv2-26_en-us.png" class="w-100" />
                            </div>
                            <div class="col-md-6 position-relative">
                                <img src="/images/bg_est_en-us.png" class="w-100" />
                                <span id="txtJPEstimate" class="bonusjp_est text-danger"></span>
                                <span class="dtstamp dtstamp--mod3" id="jpi-estjp"></span>
                            </div>
                        </div>
                    </div>
                </div>
