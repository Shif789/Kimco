    ...
    <div class="main-wrapper">
        <div class="nav-background">
            <div class="mobile-logo">
                <img src="./images/logo2.png" alt=""> <!--Insert Share99 Logo Here-->
            </div>
            <div class="mobile-nav">
                <div class="cart">
                    <div class="flex items-center">
                        <img src="./icons/cart-dark.svg" alt="">
                        <a href="#">0 Items - (RM0.00)</a>
                    </div>
                </div>
                <div class="nav-top">
                    <ul>
                ...
                <div class="contact flex items-center">
                    ...
                    <div>
                        <h5>Call us: (+60) 123 456 789</h5>
                        <h6>E-mail : support@share99.com</h6>
                    </div>
                </div>
        ...
        <div class="site-content-wrapper">
            ...
            <div class="site-content">
                ...
                <header class="hero flex items-center">
                    <div class="container">
                        <div class="welcome flex items-center">
                            <span>Welcome to Share99</span>
                           <%-- <img src="./images/logo2.png" alt=""> <!--Insert Share99 Logo Here-->--%>
                        </div>
                        <h1>The World's Best <span>Shoping</span> Website</h1>
                            ...
                            <div class="food-slider">
                                <div class="food-card magic-shadow-sm">
                                    <div class="product-image flex items-center justify-center">
                                        <img src="./images/grapes.png" alt=""> <!--Put Grapes Here-->
                                    </div>
                                    <hr>
                                    <div>
                                        <h2 class="text-center">Grapes</h2>
                                ...
                                <div class="food-card magic-shadow-sm">
                                    <div class="product-image flex items-center justify-center">
                                        <img src="./images/banana2.png" alt=""> <!--Put Bannana Here-->
                                    </div>
                                    <hr>
                                    <div>
                ...
                <section class="about-meal">
                    <div class="container">
                        <h1 class="section-heading">About Share99</h1>
                        <div class="about-meal-wrap flex">
                            <div class="flex-1">
                                <img src="./images/yogurt.png" alt="">
                            </div>
                            <div class="flex-1">
                                <h2>Share99 is a long established consortium so long that the reader will be distracted</h2>
                            ...
                            <article class="card magic-shadow-sm">
                                ...
                                <div class="card-content">
                                    <div class="post-meta flex items-center justify-between">
                                        ...
                                        <div>
                                            <span>Posted by <strong>Share99</strong></span>
                    ...
                    <div class="container flex items-center">
                        ...
                        <div>
                            ...
                            <div class="input-wrap">
                                <input type="email" placeholder="email@share99.com">
                ...
                <footer class="copyright">
                    <div>
                        Copyright © 2021 .All rights reserved by <a href="http://onebloc.io/wp/">Share99</a>.
                    </div>
                </footer>
            </div>
        </div>
